function E = elastic_mat(order, D, F, p, a11,a22,a12,s11,s22,s12,s21) 
...
betap = 36/99; 
gammap = 1/2; 
E.tauT = -1; E.tauB = -1; E.sigD = -1; E.tauR = -1;
...
%Form the matrix
  A = D2y_a11 + E.Dy_Iz*a12*E.Iy_Dz + E.Iy_Dz*a12*E.Dy_Iz + D2z_a22 + ...
     + E.tauT*E.Iy_Hinvz*E.Iy_E0z*F.dy_deta_one*(-s22*E.Iy_Sz - s21*E.Dy_Iz) + ...   
     + E.tauB*E.Iy_Hinvz*E.Iy_ENz*F.dy_deta_one*(s21*E.Dy_Iz + s22*E.Iy_Sz) + ...
     + E.tauR*E.Hinvy_Iz*E.ENy_Iz*F.one_dz_dxi*(s21*E.Iy_Sz + s11*E.Sy_Iz) + ...
...
E.E2 = F.one_dz_dxi*E.tauR*E.Hinvy_Iz*E.e0y_Iz;

E.E3 = F.dy_deta_one*E.tauT*E.Iy_Hinvz*E.Iy_e0z;
E.E4 = F.dy_deta_one*E.tauB*E.Iy_Hinvz*E.Iy_eNz;